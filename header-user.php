			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Welcome  <small> <?php echo getLoggedMemberID();  ?>
                 ...
                 <!-- /. ROW  -->
				 <footer><strong><p><center>Bus Booking System. Developed By: Foko . Brought To You by: <a href="#">Bola Jabe Na</a></p></center></strong></footer>
				</div>
             <!-- /. PAGE INNER  -->
            </div>
         <!-- /. PAGE WRAPPER  -->
